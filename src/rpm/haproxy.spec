...
%{__make} ARCH=%{_target_cpu} TARGET="linux2628" USE_PCRE_JIT=1 USE_STATIC_PCRE=1 USE_OPENSSL=1 PCRE_LIB=/tmp/static-pcre-8.39/lib PCRE_INC=/tmp/static-pcre-8.39/include SSL_INC=/tmp/static-libressl-2.3.6/include SSL_LIB=/tmp/static-libressl-2.3.6/lib ADDLIB="-ldl -lrt" USE_ZLIB=1
